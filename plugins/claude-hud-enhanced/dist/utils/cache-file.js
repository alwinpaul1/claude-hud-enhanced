 ...
 */
export function readJsonCache(filePath, isValid, onError) {
    try {
 ...
 */
export function writeJsonCacheAtomic(filePath, value, onError) {
 ...
 */
export function sweepCacheDir(cacheDir, now, onError) {
    try {
