...
function defaultSpawnDaemon(entryPath, _homeDir) {
    try {
        const child = spawn(process.execPath, [...process.execArgv, entryPath, '--daemon'], { detached: true, stdio: 'ignore', windowsHide: true, env: daemonBootEnv() });
        child.on('error', () => {
