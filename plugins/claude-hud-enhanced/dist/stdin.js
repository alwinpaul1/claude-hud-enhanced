...
function isMiniMaxAnthropicEndpoint(env = process.env) {
...
export function shouldHideUsage(stdin) {
    ...
    return ((provider !== null && API_BILLED_PROVIDERS.has(provider)) ||
 ...
 */
export function parseScopedWindows(modelScoped) {
